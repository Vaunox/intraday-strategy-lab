"""Tests for the VWAP mean-reversion spec (P3.1): fade direction, hysteresis exit,
daily reset, point-in-time prefix invariance, and the parameter factory.
...
from lab.research.strategies.vwap import VwapMeanReversionSpec, vwap_mean_reversion_spec
